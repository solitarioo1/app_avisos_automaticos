...
def descargar_shp(url, destino):
    ...
    # SENAMHI bloquea las IPs de datacenter (VPS) — si esto corre ahí, hace
    # falta el túnel SSH desde una laptop con IP residencial y pasar por su
    # proxy SOCKS5. SOCKS5_PROXY se deja vacío en local (donde sí hay salida
    # directa) y se configura solo en el entorno del VPS.
